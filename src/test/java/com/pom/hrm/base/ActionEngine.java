...
import com.relevantcodes.extentreports.LogStatus;
 ...
 public class ActionEngine extends BaseTest {
	...
	{try
	{
		for(WebElement webElement1:webElements)
		  {
			 if(webElement1.getText().contains(data))
			 {
				 webElement1.click();
			 }
		  }
	...
	public static void testExplicitWait(WebElement webElement)
	{
		WebDriverWait wt=new WebDriverWait(getWebDriver(),10);
		wt.until(ExpectedConditions.visibilityOfElementLocated((By) webElement));
	}
	...
	public void waitForJS()
	{
		...
		//ExpectedCondition<Boolean> jsload=getWebDriver()=>((JavascriptExcuter)getWebDriver());
	}
